...
public class BootIocProj20FallbackProfile {

	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(BootIocProj20FallbackProfile.class, args);
	...
	public BootIocProj20FallbackProfile() {
