...
@Repository("daoMysql")
@Profile({"test","dev"}) //Setting profile of this class
public class MysqlDaoImpl implements IDatabaseDAO {
	//CONSTANT VARIABLES 
	...
	public List<Employe> getEmploye() throws SQLException, Exception {
		System.out.println("MysqlDaoImpl DB Executing");
	...
	public MysqlDaoImpl() {
		System.out.println("MysqlDaoImpl:: 0-param constructor");
	}
}
